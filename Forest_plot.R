...
### remove fixed effects from species attribute models
ukbms_strat <- ukbms_strat[-c(1:39),] 
ukbms_mob <- ukbms_mob[-c(1:39),] 
ukbms_common <- ukbms_common[-c(1:31,33:40),]
cbc_strat <- cbc_strat[-c(1:16),] 
cbc_mob <- cbc_mob[-c(1:6),] 
cbc_common <- cbc_common[-c(1:6),] 
bbs_strat <- bbs_strat[-c(1:20),] 
bbs_mob <- bbs_mob[-c(1:8),] 
bbs_common <- bbs_common[-c(1:8),] 
...
lookup <- c("specialismwider.countryside"="Specialism", "specialismgeneralist"="Specialism", "specialismspecialist"="Specialism",
            "pop_est_stand"="Abundance", "pop_est_stand"="Abundance", "pop_estimate_stand"="Abundance",
            "mobility_wil"="Mobility", "Breeding_AM"="Mobility","mean_northing"="Mean northing", "distance"="Distance", 
            "renk_hab_sim"="Habitat similarity", "hab_sim"="Habitat similarity","specialismspecialist"="Specialism", "hab_sim1"="Habitat similarity")
